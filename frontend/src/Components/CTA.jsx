...
export const CTA = () => {
    ...
    return <div>
        <section class="relative z-10 rounded-2xl overflow-hidden bg-[#06b6d4] py-16 px-8 mt-40">
            <div class="container">
                <div class="-mx-4 flex flex-wrap items-center">
                    <div class="w-full px-4 lg:w-1/2">
                        <div class="text-center lg:text-left ">
                            <div class="mb-10 lg:mb-0 ">
                                <h1
                                    class="mt-0 mb-3 text-3xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[60px] md:leading-tight text-[#cffafe] ">
                                    Expand your library and make your books smarter</h1>
                                <p
                                    class="w-full text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed text-[#cffafe]">
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="w-full px-4 lg:w-1/3">
                        <div class="text-center lg:text-right"><a
                            class="font-semibold rounded-lg mx-auto inline-flex items-center justify-center bg-[#cffafe] py-4 px-9 hover:bg-opacity-80"
                            href="#"
                            onClick={()=>{navigate("/signup")}}>Join us today</a>
                        </div>
                    </div>
                </div>
            </div>
